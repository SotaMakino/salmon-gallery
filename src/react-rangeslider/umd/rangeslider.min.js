!(function(e, t) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? (exports.ReactRangeslider = t(require("react")))
    : (e.ReactRangeslider = t(e.React));
})(this, function(e) {
  return (function(e) {
    function t(r) {
    ...
    function(e, t) {
      ...
      function a() {
        v &&
          p &&
          ((v = !1), p.length ? (h = p.concat(h)) : (y = -1), h.length && s());
      }
      function s() {
        if (!v) {
          var e = o(a);
    ...
    function(e, t, n) {
            ...
            return (
              ...
              (r.handleUpdate = function() {
                if (r.slider) {
                  var e = r.props.orientation,
                    t = (0, m.capitalize)(b.orientation[e].dimension),
                    n = r.slider["offset" + t],
                    o = r.handle["offset" + t];
                  r.setState({ limit: n - o, grab: o / 2 });
                }
              }),
              ...
              (r.handleDrag = function(e) {
                ...
                if (t && "rangeslider__labels" !== o) {
                  var s = r.position(e);
                  i &&
                    i.contains("rangeslider__label-item") &&
                    a.value &&
              ...
              (r.handleKeyDown = function(e) {
                ...
                switch (t) {
                  case 38:
                  case 39:
                    (c = o + s > a ? a : o + s), u && u(c, e);
                    break;
                  case 37:
                  case 40:
                    (c = o - s < i ? i : o - s), u && u(c, e);
                }
              }),
              ...
              (r.getValueFromPosition = function(e) {
                var t = r.state.limit,
                  ...
                  a = n.max,
                  s = n.step,
                  u = (0, m.clamp)(e, 0, t) / (t || 1),
                  c = s * Math.round((u * (a - i)) / s),
                  l = "horizontal" === o ? c + i : a - c;
                return (0, m.clamp)(l, i, a);
              }),
              (r.position = function(e) {
                var t = r.state.grab,
                  ...
                  i = n.reverse,
                  a = r.slider,
                  s = b.orientation[o].coordinate,
                  u = i
                    ? b.orientation[o].reverseDirection
                    : b.orientation[o].direction,
                  c = "client" + (0, m.capitalize)(s),
                  l = e.touches ? e.touches[0][c] : e[c],
                  f = a.getBoundingClientRect()[u],
                  d = i ? f - l - t : l - f - t,
                  p = r.getValueFromPosition(d);
                return p;
              }),
              (r.coordinates = function(e) {
                var t = r.state,
                  ...
                  u = "horizontal" === i ? s + o : s,
                  c = "horizontal" === i ? u : n - u;
                return { fill: c, handle: u, label: u };
              }),
              (r.renderLabels = function(e) {
                return d.default.createElement(
                  "ul",
                  {
                    ...
                    className: (0, l.default)("rangeslider__labels")
                  },
                  e
                );
              }),
            ...
            u(t, [
              {
                ...
                value: function() {
                  this.handleUpdate();
                  var e = new y.default(this.handleUpdate);
              ...
              },
              {
                ...
                value: function() {
                  var e = this,
                    ...
                    p = t.handleLabel,
                    h = this.state.active,
                    v = b.orientation[r].dimension,
                    y = s
                      ? b.orientation[r].reverseDirection
                      : b.orientation[r].direction,
                    m = this.getPositionFromValue(n),
                    g = this.coordinates(m),
                    _ = o({}, v, g.fill + "px"),
                    w = o({}, y, g.handle + "px"),
                    E = a && h,
                    O = [],
                  ...
                  if (x.length > 0) {
                    ...
                    try {
                      for (
                        var j, A = x[Symbol.iterator]();
                        !(T = (j = A.next()).done);
                        T = !0
                      ) {
                        var D = j.value,
                          N = this.getPositionFromValue(D),
      ...
      (g.propTypes = {
        ...
        step: h.default.number,
        value: h.default.number,
        orientation: h.default.string,
        tooltip: h.default.bool,
        reverse: h.default.bool,
        labels: h.default.object,
        handleLabel: h.default.string,
        format: h.default.func,
        onChangeStart: h.default.func,
        onChange: h.default.func,
        onChangeComplete: h.default.func
      }),
        (g.defaultProps = {
          min: 0,
          max: 100,
	...
	*/
            ...
            switch (typeof t) {
              ...
              case "object":
                ...
                var r,
                  o = n.call(t);
                if (n !== t.entries) {
                  for (; !(r = o.next()).done; ) if (!E(r.value)) return !1;
                } else
                  for (; !(r = o.next()).done; ) {
                    var i = r.value;
                    if (i && !E(i[1])) return !1;
    ...
    function(e, t, n) {
      !(function(t, n) {
        ...
        function n(t) {
          for (
            var n = ["top", "right", "bottom", "left"], r = {}, o = 0, i = n;
            o < i.length;
            o += 1
          ) {
            var a = i[o],
        ...
        function o(r) {
          ...
          if (
            ("border-box" === s.boxSizing &&
              (Math.round(d + l) !== o && (d -= t(s, "left", "right") + l),
              Math.round(p + f) !== a && (p -= t(s, "top", "bottom") + f)),
            !i(r))
          ) {
            var h = Math.round(d + l) - o,
              v = Math.round(p + f) - a;
            1 !== Math.abs(h) && (d -= h), 1 !== Math.abs(v) && (p -= v);
          }
          return u(c.left, c.top, d, p);
        }
        function i(e) {
        ...
        var c = (function() {
          ...
          m = "undefined" != typeof MutationObserver && !y,
          b = function() {
            (this.connected_ = !1),
              ...
              (this.refresh = p(this.refresh.bind(this), h));
          };
        ...
        var T = "undefined" != typeof WeakMap ? new WeakMap() : new c(),
          R = function(e) {
        ...
        var P = (function() {
          return "undefined" != typeof ResizeObserver ? ResizeObserver : R;
        })();
        return P;
      });
    },
